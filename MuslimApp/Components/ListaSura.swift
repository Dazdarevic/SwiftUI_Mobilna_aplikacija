...
struct ListaSura_Previews: PreviewProvider {
    static var previews: some View {
//        VStack {
//            ListaSura(onCellPressed: {
//                print("Cell 1 pressed")
//            })
//            ListaSura(onCellPressed: {
//                print("Cell 2 pressed")
//            })
//            ListaSura(onCellPressed: {
//                print("Cell 3 pressed")
//            })
//        }
        ListaSura()
    }
